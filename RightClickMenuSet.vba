...
'This was a security measure for the application to limit the right click menu to the user to prevent them from being able to manipulate any underlying code.
'It sets and limits the right click mouse menu so the user only had in-app actionable ability.
